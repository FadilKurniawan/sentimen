...
import 'package:sentimen/data/widgets/base_shimmer.dart';
...
class _StateHandleWidgetState extends State<StateHandleWidget> {
  ...
  Widget build(BuildContext context) {
    var loadingWidget = widget.shimmerView ??
        IgnorePointer(child: BaseShimmer.buildShimmerList());
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image(
                image: widget.emptyImage ?? Resources.images.imgEmpty,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              alignment: Alignment.center,
              child: Image(
                image: Resources.images.imgError,
                fit: BoxFit.fill,
              ),
            ),
            SizedBox(
